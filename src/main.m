...
for i = 1: length(PSNR)
	...
	% average of 10 times
	block_err_hard2(i) = block_err_hard2(i)/10; block_err_hard3(i) = block_err_hard3(i)/10;
	block_err_soft2(i) = block_err_soft2(i)/10; block_err_soft3(i) = block_err_soft3(i)/10;
	error_ratio_hard2(i) = error_ratio_hard2(i)/10; error_ratio_hard3(i) = error_ratio_hard3(i)/10;
	error_ratio_soft2(i) = error_ratio_soft2(i)/10; error_ratio_soft3(i) = error_ratio_soft3(i)/10;
	fail_ratio_hard2(i) = fail_ratio_hard2(i)/10; fail_ratio_hard3(i) = fail_ratio_hard3(i)/10;
	fail_ratio_soft2(i) = fail_ratio_soft2(i)/10; fail_ratio_soft3(i) = fail_ratio_soft3(i)/10;
	err_noEnd_hard2(i) = err_noEnd_hard2(i)/10; err_noEnd_hard3(i) = err_noEnd_hard3(i)/10;
